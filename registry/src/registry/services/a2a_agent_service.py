...
class A2AAgentService:
    ...
    async def list_agents(
        ...
        page: int = 1,
        per_page: int = 20,
        accessible_agent_ids: list[PydanticObjectId] | None = None,
        ...
        Args:
            ...
            accessible_agent_ids: List of agent IDs accessible to the user
        ...
        try:
            ...
            if accessible_agent_ids is not None:
                filters["_id"] = {"$in": accessible_agent_ids}
        ...
        try:
            ...
            if "provider" in update_data and update_data["provider"] is not None:
                ...
                agent.provider = AgentProvider(
                    organization=data.provider.organization, url=data.provider.url
                )
