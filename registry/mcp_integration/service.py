...
from api.mcp_oauth_router import get_oauth_service
from mcp_integration.config.service import get_config_service
from mcp_integration.models.enums import ConnectionState
from mcp_integration.services.connection_service import get_connection_service
...
class MCPService:
    ...
    async def update_connection_state(
        ...
        from app.models.mcp_models import ConnectionState
...
async def get_mcp_service() -> MCPService:
    """Get MCP service instance (singleton)"""
