...
from ..core.providers import create_provider_from_env
...
class Model(metaclass=ModelMeta):
    ...
    def create_collection(cls) -> bool:
        cls._init_manager()
        return cls.objects.create_collection()

    @classmethod
    def delete_collection(cls) -> bool:
        cls._init_manager()
        return cls.objects.delete_collection()

    @classmethod
    def collection_exists(cls) -> bool:
        cls._init_manager()
        return cls.objects.collection_exists()
    ...
    def get_collection_info(cls) -> Optional[Dict[str, Any]]:
        cls._init_manager()
        return cls.objects.get_collection_info()
