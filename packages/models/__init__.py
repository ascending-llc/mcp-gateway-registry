...
try:
    ...
    __all__ = ['McpTool', 'ToolDiscoveryMode', 'ExtendedMCPServer', 'MCPServerDocument'] + _generated_all
except ImportError:
    # _generated doesn't exist yet - will be created by import-schemas
    __all__ = ['McpTool', 'ToolDiscoveryMode', 'ExtendedMCPServer', 'MCPServerDocument']
