...
def _update_vscode_config(noauth_services: list[dict[str, Any]], ingress_headers: dict[str, str] | None) -> None:
...
def _update_roocode_config(noauth_services: list[dict[str, Any]], ingress_headers: dict[str, str] | None) -> None:
