...
def _get_auth_token(explicit_token: str | None = None, env_var_name: str = "MCP_AUTH_TOKEN") -> str | None:
    """
...
class MCPClient:
    ...
    def __init__(
        self, gateway_url: str, access_token: str | None = None, backend_token: str | None = None, timeout: int = 30
    ):
        """
    ...
    def _make_request(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            request = urllib.request.Request(self.gateway_url, data=data, headers=headers, method="POST")
...
def create_mcp_client(gateway_url: str, access_token: str | None = None, timeout: int = 30) -> MCPClient:
    """
...
def create_mcp_session(gateway_url: str, access_token: str | None = None, timeout: int = 30) -> MCPSession:
    """
