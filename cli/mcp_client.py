...
Authentication (priority order):
  ...
  4. Ingress token: Automatically loaded from ~/.mcp/ingress_token if available
    ...
    parser.add_argument("--url", default="http://localhost/mcpgw/mcp", help="Gateway URL (default: %(default)s)")
    parser.add_argument("--token-file", help="Path to file containing access token (e.g., .cognito_access_token)")
    parser.add_argument("command", choices=["ping", "list", "call", "init"], help="Command to execute")
