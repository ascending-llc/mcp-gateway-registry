    ...
    async def _extract_user_context(self):
        ...
        try:
            ...
            if request.user.is_authenticated:
                ...
                if hasattr(request.user, "access_token") and hasattr(
                    request.user.access_token, "claims"
                ):
                    ...
                    raise HTTPException(
                        status_code=401, detail="Authenticated request missing access_token.claims"
                    )
