          ...
          <div className='flex items-start justify-between mb-4'>
            <div className='flex-1 min-w-0'>
              <div className='flex items-center gap-2 mb-3'>
                <h3 className='text-lg font-bold text-gray-900 dark:text-white truncate'>{agent.name}</h3>
                ...
                {agent.trust_level && (
                  <span
                    className={`px-2 py-0.5 text-xs font-semibold rounded-full flex-shrink-0 flex items-center gap-1 ${getTrustLevelColor()}`}
                  >
                    {getTrustLevelIcon()}
                ...
                {agent.visibility && (
                  <span
                    className={`px-2 py-0.5 text-xs font-semibold rounded-full flex-shrink-0 flex items-center gap-1 ${
              ...
              {agent.version && <span className='ml-2 text-xs text-gray-500 dark:text-gray-400'>v{agent.version}</span>}
              {agent.url && (
                <a
                  href={agent.url}
                  target='_blank'
