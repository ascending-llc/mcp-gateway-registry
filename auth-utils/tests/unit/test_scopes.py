...
class TestLoadScopesConfig:
    ...
    def test_returns_empty_dict_when_file_missing(self, tmp_path):
        ...
        with patch("auth_utils.scopes.settings") as mock_settings:
            mock_settings.scopes_file_path = tmp_path / "nonexistent.yml"
    ...
    def test_loads_valid_yaml(self, tmp_path):
        ...
        with patch("auth_utils.scopes.settings") as mock_settings:
            mock_settings.scopes_file_path = scopes_file
            result = load_scopes_config()
    ...
    def test_returns_empty_dict_on_exception(self, tmp_path):
        ...
        with patch("auth_utils.scopes.settings") as mock_settings:
            mock_settings.scopes_file_path = tmp_path / "scopes.yml"
            # Patch open to raise
...
class TestMapGroupsToScopes:
    ...
    def test_maps_known_group(self, tmp_path):
